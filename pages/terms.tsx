  ...
  return (
    <Center sx={{ width: '100vw' }}>
      <Stack sx={{ maxWidth: '65ch' }}>
        ...
        <p>Welcome to Essays with Ori!</p>

        <p>
          These terms and conditions outline the rules and regulations for the use of Essays with
          Ori's Website, located at essayswithori.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue
          to use Essays with Ori if you do not agree to take all of the terms and conditions stated
          on this page.
        </p>
        ...
        <p>
          We employ the use of cookies. By accessing Essays with Ori, you agreed to use cookies in
          agreement with the Essays with Ori's Privacy Policy.{' '}
        </p>
        ...
        <p>
          Unless otherwise stated, Essays with Ori and/or its licensors own the intellectual
          property rights for all material on Essays with Ori. All intellectual property rights are
          reserved. You may access this from Essays with Ori for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Essays with Ori</li>
          <li>Sell, rent or sub-license material from Essays with Ori</li>
          <li>Reproduce, duplicate or copy material from Essays with Ori</li>
          <li>Redistribute content from Essays with Ori</li>
        </ul>
        ...
        <p>
          ...
          information in certain areas of the website. Essays with Ori does not filter, edit,
          publish or review Comments prior to their presence on the website. Comments do not reflect
          the views and opinions of Essays with Ori,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, Essays with Ori shall not be liable for the Comments or for
          any liability, damages or expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>

        <p>
          Essays with Ori reserves the right to monitor all Comments and to remove any Comments
        ...
        <p>
          You hereby grant Essays with Ori a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of Essays with Ori; and (d) the link
        ...
        <p>
          ...
          linking to our website, you must inform us by sending an e-mail to Essays with Ori. Please
        ...
        <p>
          No use of Essays with Ori's logo or other artwork will be allowed for linking absent a
